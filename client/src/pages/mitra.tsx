...
import { Users, UserCheck, Phone, Calendar, Star, MapPin, MessageCircle } from 'lucide-react';
  ...
  const mockMitras: MitraProfile[] = [
    {
      ...
      rating: 4.8,
      profileImage: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=150&h=150'
    },
    {
      id: '2',
      name: 'प्रिया शर्मा',
      ...
      rating: 4.9,
      profileImage: 'https://images.unsplash.com/photo-1494790108755-2616c-c-4ec6-bc-1168-a35d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150'
    }
  ];
  ...
  const mitraServices = [
    {
      ...
      description: isHindi ? "आसान भाषा में समझाते हैं" : "Explain in simple language"
    },
    {
      icon: "📋",
    ...
    },
    {
      ...
      description: isHindi ? "परिवार से जुड़े रहते हैं" : "Stay connected with family"
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              {mitras.map((mitra) => (
                <Card key={mitra.id} className="hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold text-foreground">{mitra.name}</h4>
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          {isHindi ? "आपके क्षेत्र के लिए प्रशिक्षित सहायक" : "Trained assistant for your area"}
                        </p>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-foreground mb-4">
                  {isHindi ? "आपके क्षेत्र में हमारी उपस्थिति" : "Our Presence in Your Area"}
                </h3>
        ...
        <section className="mt-16 bg-destructive/5 border border-destructive/20 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              {isHindi ? "तुरंत मदद के लिए संपर्क करें" : "Contact for immediate assistance"}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-chart-2 bg-chart-2/5">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-2xl font-bold text-chart-2 mb-2">1800-22-9090</p>
                <p className="text-sm text-muted-foreground">
                  {isHindi ? "सभी भाषाओं में उपलब्ध" : "Available in all languages"}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary bg-primary/5">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-lg font-bold text-primary mb-2">+91 98765-43210</p>
                <p className="text-sm text-muted-foreground">
            ...
            <Card className="border-chart-3 bg-chart-3/5">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  {isHindi ? "व्यक्तिगत बातचीत के लिए" : "For personal consultation"}
                </p>
